...
package org.wahlzeit.model.user;
...
import org.wahlzeit.model.photos.PhotoFilter;
...
public class UserSession extends Session {
	...
	protected PhotoFilter photoFilter = CatPhotoFactory.getInstance().createPhotoFilter();
